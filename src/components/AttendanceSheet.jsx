    ...
    <main style={pageStyles}>
      ...
      <div style={cardStyles}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          <label style={{ color: '#d7dcff', fontSize: '0.95rem', fontWeight: 600 }}>
            Mes:
          </label>
          <input
            type="month"
          ...
          <button 
            ...
            onClick={() => {
              const datosParaGuardar = {
                cursoId: id,
                mes: mesSeleccionado,
                asistencias: Object.entries(asistencias).map(([clave, estado]) => {
                  const [alumnoId, fecha] = clave.split('_');
                  return { alumnoId, fecha, estado };
                })
              };
              console.log('Datos para guardar asistencia:', datosParaGuardar);
            }}
          >
            Guardar asistencia
          </button>
